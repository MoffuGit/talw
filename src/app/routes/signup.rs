...
pub fn Signup() -> impl IntoView {
    ...
    leptos::on_cleanup(move || signup.value().set(None));
    view! {
        <ActionForm action=signup class="w-full h-full flex flex-col items-center">
            ...
            <div class="form-control w-full max-w-xs mb-2">
                ...
                <input type="text" placeholder="Enter your ID..." maxlength="32" name="username" class="input input-bordered input-sm w-full max-w-xs" />
            </div>
            <div class="form-control w-full max-w-xs mb-2">
                <label class="label">
            ...
            <div class="form-control w-full max-w-xs mb-2">
                ...
                <input type="password" placeholder="Password again" name="confirmation_password" class="input input-bordered input-sm w-full max-w-xs" />
            </div>
            <div class="form-control w-full max-w-xs mb-2">
            ...
            <button type="submit" class="btn btn-sm btn-outline btn-error w-full max-w-xs mb-2" disabled=move || signup.pending().get()>"Sing Up"</button>
            <Transition fallback=move || ()>
                {move || {
                    signup.value().get().map(|res| match res {
