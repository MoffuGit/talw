                ...
                <ActionForm action=create_category node_ref=form_ref class="w-full">
                    <div class="px-[16px] w-full">
                        ...
                        <div class="mt-2 mb-4 w-full bg-base-300 rounded flex items-center">
                            <input name="name" type="text" placeholder="new-category" class="w-full h-10 bg-base-300 py-[10px] px-2"/>
                        </div>
                    </div>
                    <div class="relative p-4 flex justify-end w-full bg-base-200">
                        ...
                        <input minlength="1" value=server_id.to_string() type="hidden" name="server_id"/>
