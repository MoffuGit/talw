...
pub fn MemberBanner(
    ...
    view! {
        <DropdownProvider modal=false open=is_open>
            ...
            <DropdownContent
                class="w-72 h-auto z-50 rounded-lg bg-base-200"
                side=side
                align=align
                side_of_set=20.0
                limit_y=limit_y
                                            ...
                                            view! {
                                                <div class="relative w-full h-auto ">
                                                    ...
                                                    {if let Some(url) = image_url.get_value() {
                                                        view! {
                                                            <img
                                                                class="w-[96px] h-[96px] object-cover absolute top-16 left-2 rounded-full border-[6px] border-base-200"
                                                                src=url
                                                            />
                                                        }
                                                            .into_view()
                                                    ...
                                                    <div class="relative w-auto mt-12 m-4">
                                                        <div class="text-xl font-bold bg-base-200">
                                                            {name.get_value()}
                                                        </div>
